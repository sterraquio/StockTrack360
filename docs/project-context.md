...
|---|---|
| HU-01 | Permite ingresar correo y contraseña. Si son correctos, permite acceso e identifica rol. Si son incorrectos, muestra `Usuario o contraseña incorrectos` sin revelar el motivo. |
